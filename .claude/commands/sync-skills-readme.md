...
| Development | 🛠️ | command, session, handoff, entropy, development, workflow |
| Design & Frontend | 🎨 | design, frontend, ui, openapi, typescript, system |
| Utilities | 🔧 | domain, meme, web-to-markdown, utility, tool |
| Planning | 🎯 | plan, planning, spec, forge, requirements, clarity, game-changing, features |
| Professional | 👔 | professional, communication, career, soft-skill |
...
**Sorting:**
- Group by category (AI Tools first, then Documentation, Development, etc.)
